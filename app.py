...
with tab2:
    ...
    selected_types = selected_types = st.multiselect("Filtra por tipo(s)", all_types, placeholder="Elige tipos, ej: Agua, Hada, Acero", default=["FIRE"] if "FIRE" in all_types else [])
